...
float local2 = float(1.000000);
float4 local1 = float4(random(0.101251 + DeltaTime + float(dispatchThreadId.x)), random(0.201251 + DeltaTime + float(dispatchThreadId.x)), random(0.301251 + DeltaTime + float(dispatchThreadId.x)), random(0.401251 + DeltaTime + float(dispatchThreadId.x)));
float4 local3 = float4(local1.xyz, local2);
float4 local0 = float4(1.000000, 1.000000, 1.000000, 1.000000);
float4 local4 = local0 + local3;
